const ConfBox = ({handleYes, handleNo, children}) => {
  ...
  return (
    ...
    <section onClick={handleNo} className="fixed z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-screen flex flex-col items-center justify-center bg-transparent">
        <section className="bg-gray-900 border-2 p-5 shadow-sm shadow-black flex flex-col justify-between">
